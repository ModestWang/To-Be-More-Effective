/**
****************************************************************************************
* @FilePath: item_55.cpp
* @Author: Modest Wang 1598593280@qq.com
* @Date: 2024-01-31 19:02:48
* @LastEditors: Modest Wang
* @LastEditTime: 2024-01-31 19:02:48
* @2024 by Modest Wang, All Rights Reserved.
* @Descripttion: 让自己熟悉Boost
****************************************************************************************
*/

// Boost是一个由C++社区开发的、免费的、开源的、经过广泛测试的、供人们使用的、可移植的、提供源代码的、
// 具有高质量的C++程序库。Boost的目标是提高C++程序库的质量，使C++程序员更加容易地开发C++程序。

// Boost的下载：http://www.boost.org/
...
*基本介绍*
Boost库是为C++语言标准库提供扩展的一些C++程序库的总称。Boost库由Boost社区组织开发、维护。其目的是为C++程序员提供免费、同行审查的、可移植的程序库。
...
很多Boost中的库功能堪称对语言功能的扩展，其构造用尽精巧的手法，不要贸然的花费时间研读。
